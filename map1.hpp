...
class Map{
    ...
    Node *tail = new Node();
    std::size_t length = 0;
    Node *garbage= nullptr;//= new Node();
    Node *garbage_end = nullptr; //= new Node();
...
Map<T,H>::~Map()
{
   ...
   for(Node * i = this->garbage;i != this->garbage_end;)
    {   
        if(i ==nullptr)return;
        //std::cout<<"gar "; 
        Node *n = i->left;
...
{   
    ...
    if(this->garbage == nullptr)
    {
        ...
        //std::cout<<"First";
        this->garbage = i.iter_node;
        this->garbage_end = i.iter_node;
    } 
    else
    {
        //std::cout<<"Rest";
        this->garbage_end->left = i.iter_node;
        this->garbage_end = i.iter_node;
